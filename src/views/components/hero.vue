        ...
        <v-flex xs-6 style="margin-top: 75px; padding-top: 70px; text-align: left;">
          ...
          <div class="icon-row">
            <span style="margin-left: 5px; margin-right: 5px; padding: 3px;" >
              <v-tooltip bottom v-if="details.facebook.length > 0">
            ...
            <span style="margin-left: 5px; margin-right: 5px; padding: 3px;" >
              <v-tooltip bottom v-if="details.instagram.length > 0">
                <template v-slot:activator="{ on }">
            ...
            <span style="margin-left: 5px; margin-right: 5px; padding: 3px;">
              <v-tooltip bottom v-if="details.twitter.length > 0">
                <template v-slot:activator="{ on }">
            ...
            <span style="margin-left: 5px; margin-right: 5px; padding: 3px;">
              <v-tooltip bottom v-if="details.email.length > 0">
                <template v-slot:activator="{ on }">
            ...
            <span style="margin-left: 5px; margin-right: 5px; padding: 3px;">
              <v-tooltip bottom v-if="details.github.length > 0">
                <template v-slot:activator="{ on }">
            ...
            <span style="margin-left: 5px; margin-right: 5px; padding: 3px;">
              <v-tooltip bottom v-if="details.linkedin.length > 0">
                <template v-slot:activator="{ on }">
            ...
            <span style="margin-left: 5px; margin-right: 5px; padding: 3px;">
              <v-tooltip bottom v-if="details.medium.length > 0">
                <template v-slot:activator="{ on }">
            ...
            <span style="margin-left: 5px; margin-right: 5px; padding: 3px;">
              <v-tooltip bottom v-if="details.spotify.length > 0">
                <template v-slot:activator="{ on }">
            ...
            <span style="margin-left: 5px; margin-right: 5px; padding: 3px;">
              <v-tooltip bottom v-if="details.fiveHundredPx.length > 0">
                <template v-slot:activator="{ on }">
          ...
          <v-btn target="_blank" v-if="details.resumeLink.length > 0" :href="details.resumeLink" color="#580aff" style="margin-left: 12px!important; text-transform: capitalize; border-radius:5px; color:white">
            My Resume
          </v-btn>
        </v-flex>
      </v-layout>
